...
import { at as stripLocalePrefix, au as getMercedesModelByPath, S as SITE_URL, av as MERCEDES_HUB_PATH, p as pageGraph, b as buildWebPage, a as buildBreadcrumb, c as buildService, e as useSeo, aw as mercedesModelPages, H as Header, L as LocalizedLink, ax as MERCEDES_SERVICE_LINKS, G as Accordion, I as AccordionItem, J as AccordionTrigger, K as AccordionContent, f as Footer } from "../entry-server.js";
import "node:stream";
...
const ModelSystemSection = ({ section, servicePath, serviceLabel }) => /* @__PURE__ */ jsxs("section", { className: "card-premium rounded-2xl p-5 sm:p-7", children: [
  ...
  /* @__PURE__ */ jsxs(LocalizedLink, { to: servicePath, className: "mt-5 inline-flex items-center gap-2 text-sm font-semibold text-burnt-orange hover:underline", children: [
    serviceLabel,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-black text-off-white", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-b from-charcoal/20 to-black py-14 sm:py-20", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6", children: [
        ["Mercedes S-Class", "Mercedes-AMG S63", "Mercedes GLS"].includes(model.name) && /* @__PURE__ */ jsxs("p", { className: "mb-8 text-sm leading-7 text-white/65", children: [
          "For Maybach-specific equipment, see the ",
          /* @__PURE__ */ jsx(LocalizedLink, { to: "/brands/maybach-service-dubai", className: "text-burnt-orange hover:underline", children: "Maybach service and repair hub" }),
          ". Compare ",
          /* @__PURE__ */ jsx(LocalizedLink, { to: "/blog/mercedes-s-class-service-dubai-guide", className: "text-burnt-orange hover:underline", children: "S-Class and S65 assessment" }),
          " with ",
          /* @__PURE__ */ jsx(LocalizedLink, { to: "/mercedes/models/s63-service-repair-dubai", className: "text-burnt-orange hover:underline", children: "S63 AMG service scope" }),
          " for the fitted powertrain."
        ] }),
        model.name === "Mercedes G-Class" && /* @__PURE__ */ jsxs("p", { className: "mb-8 text-sm leading-7 text-white/65", children: [
          "For the AMG powertrain and model-specific equipment, use the ",
          /* @__PURE__ */ jsx(LocalizedLink, { to: "/blog/mercedes-g63-service-dubai-guide", className: "text-burnt-orange hover:underline", children: "Mercedes-AMG G63 service guide" }),
          "."
        ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid gap-5 lg:grid-cols-2", children: [
        ...
        ].map(({ section, path, label }) => /* @__PURE__ */ jsx(ModelSystemSection, { section, servicePath: path, serviceLabel: label }, section.title)) })
      ] }) }),
