...
import { u as useLocale, ai as getBlogPostBySlug, a as buildBreadcrumb, b as buildWebPage, aj as buildArticle, d as buildFAQ, p as pageGraph, e as useSeo, af as blogPosts, H as Header, L as LocalizedLink, F as FinalCTA, f as Footer, ak as getBrandWorkshopArticle, S as SITE_URL, c as buildService, al as brandWorkshopArticles, C as CtaAssurance, G as Accordion, I as AccordionItem, J as AccordionTrigger, K as AccordionContent, am as PORSCHE_GUIDES_PARENT_PATH, an as PORSCHE_HUB_PATH, ao as porscheOwnershipGuides, ap as PORSCHE_GUIDES_PATH, aq as getPorscheModelByLegacyBlogSlug, ar as getMercedesModelByLegacyBlogSlug } from "../entry-server.js";
...
import MercedesModelPage from "./MercedesModelPage-CbYAVwQF.js";
import PorscheModelPage from "./PorscheModelPage-3a0JuV0U.js";
import "node:stream";
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxs("article", { className: "mx-auto max-w-4xl px-5 py-14 sm:px-6 sm:py-20", children: [
        /* @__PURE__ */ jsxs("section", { className: `${isArabic ? "border-r-2 pr-5" : "border-l-2 pl-5"} border-burnt-orange`, children: [
          ...
          article.existingBestPage && /* @__PURE__ */ jsxs("p", { className: "mt-4 leading-relaxed text-gray-400", children: [
