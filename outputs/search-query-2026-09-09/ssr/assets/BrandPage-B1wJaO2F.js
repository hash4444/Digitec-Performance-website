...
import { u as useLocale, t as trackWhatsAppClick, L as LocalizedLink, aW as porscheModelNavigation, aX as porscheSystemNavigation, aY as porscheProblemNavigation, aZ as porscheGuideNavigation, aI as BMW_HUB_PATH, aJ as bmwModelPages, a_ as FERRARI_HUB_SERVICES, a$ as FERRARI_WHATSAPP_HREF, aM as ferrariModelPages, b0 as FERRARI_MAINTENANCE_GUIDE_PATH, b1 as FERRARI_488_GUIDE_PATH, a8 as lamborghiniUrusWorkshop, aG as audiModelPages, aE as audiModelPath, b2 as getBrandBySlug, b3 as rangeRoverWorkshop, a7 as defenderWorkshop, a as buildBreadcrumb, b as buildWebPage, b4 as buildBrand, b5 as BRAND_OFFER_CATALOG, c as buildService, d as buildFAQ, p as pageGraph, e as useSeo, r as brands, B as getServiceBySlug, b6 as getServicesForBrand, b7 as BRAND_PROFILES, H as Header, C as CtaAssurance, b8 as mercedesAmgEngine, b9 as g63BrabusFinishedFront, ax as MERCEDES_PROBLEMS_PATH, av as mercedesModelPages, G as Accordion, I as AccordionItem, J as AccordionTrigger, K as AccordionContent, f as Footer } from "../entry-server.js";
import { z } from "zod";
import { l as localizeBrandToArabic, a as arBrandServices, b as arBrandServiceNames } from "./ar-brands-X-pC83Mz.js";
...
const BrandPage = () => {
  ...
  useSeo({
    title: brand ? isArabic ? `إصلاح وصيانة ${brand.name} في دبي | مركز ديجي-تك` : specialistHubTitle ?? `${brand.name} Repair Dubai | Digi-Tec` : "Brand Service in Dubai | Digi-Tec Performance Centre",
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("main", { id: "main-content", className: "brand-page-main", children: [
          ...
          /* @__PURE__ */ jsxs("section", { className: `brand-hero brand-hero--${brandPageDesign.art} theme-dark-section relative overflow-hidden border-b border-white/[0.08] bg-black`, children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "brand-hero__shell relative z-10 mx-auto max-w-[90rem] px-5 sm:px-8 lg:px-12", children: /* @__PURE__ */ jsx("div", { className: "brand-hero__copy max-w-4xl", children: /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("h1", { className: "brand-hero__title mb-5 max-w-4xl text-[clamp(2.75rem,5vw,5.25rem)] font-semibold leading-[0.98] tracking-[-0.05em]", children: [
        ...
        /* @__PURE__ */ jsx(Footer, {}),
        isPriorityLeadBrand && /* @__PURE__ */ jsx("aside", { className: "fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-black/95 p-3 shadow-2xl backdrop-blur md:hidden", "aria-label": `${brand.name} booking options`, children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-lg grid-cols-2 gap-3", children: [
