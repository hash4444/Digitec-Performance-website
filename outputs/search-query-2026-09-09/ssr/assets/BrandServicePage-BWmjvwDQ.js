...
import { u as useLocale, ba as getBrandServiceCombo, b2 as getBrandBySlug, S as SITE_URL, a as buildBreadcrumb, b as buildWebPage, b4 as buildBrand, c as buildService, d as buildFAQ, p as pageGraph, b7 as BRAND_PROFILES, e as useSeo, b6 as getServicesForBrand, ax as MERCEDES_PROBLEMS_PATH, b0 as FERRARI_MAINTENANCE_GUIDE_PATH, H as Header, L as LocalizedLink, C as CtaAssurance, G as Accordion, I as AccordionItem, J as AccordionTrigger, K as AccordionContent, f as Footer } from "../entry-server.js";
...
const BrandServicePage = ({
  ...
  const sourceCombo = brandSlug && serviceSlug ? getBrandServiceCombo(brandSlug, serviceSlug) : void 0;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "site-page min-h-screen bg-black text-off-white", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "relative overflow-hidden border-b border-white/[0.08] bg-[#101113]", children: /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto max-w-[90rem] px-5 py-14 sm:px-8 sm:py-20 lg:px-12 lg:py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "mb-5 max-w-4xl text-[clamp(2.65rem,5vw,5.1rem)] font-semibold leading-[0.98] tracking-[-0.05em]", children: isArabic ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-12 sm:py-16 bg-gradient-to-br from-charcoal/40 to-black", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6", children: [
      ...
      ] }) : combo.brandSlug === "mclaren-service-dubai" ? /* @__PURE__ */ jsxs(Fragment, { children: [
        "McLaren models for ",
        /* @__PURE__ */ jsx("span", { className: "text-burnt-orange", children: combo.serviceName })
    ...
    relatedAuthorityContent.length > 0 && !isArabic && /* @__PURE__ */ jsx("section", { className: "border-t border-white/5 bg-charcoal/15 py-12 sm:py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-3xl text-sm leading-relaxed text-white/55", children: "These informational pages explain the warning or platform. This page remains the commercial destination for the confirmed service need." }),
