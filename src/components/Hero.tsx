  ...
  return (
    <section className="relative min-h-[88vh] sm:min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto">
        ...
        <h2 className="text-base sm:text-2xl md:text-3xl lg:text-5xl font-bold mb-3 sm:mb-6 text-burnt-orange">
          Where Performance Meets Precision.
        </h2>
        
        <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-12 max-w-4xl mx-auto leading-snug sm:leading-relaxed px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 justify-center items-center px-4">
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center bg-burnt-orange hover:bg-burnt-orange/90 text-black font-bold text-sm sm:text-lg px-6 sm:px-12 py-3.5 sm:py-6 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
          >
            Book Appointment
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto inline-flex items-center justify-center border-2 border-off-white bg-off-white text-black hover:bg-white hover:text-black font-bold text-sm sm:text-lg px-6 sm:px-12 py-3.5 sm:py-6 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            Get a Free Diagnosis
          </a>
        </div>
        
        <div className="mt-6 sm:mt-16 animate-bounce">
