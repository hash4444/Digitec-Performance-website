      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          <div className="text-center group">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-white">Performance Tuning</h3>
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg px-2">
          ...
          <div className="text-center group">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-white">Aesthetic Enhancement</h3>
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg px-2">
          ...
          <div className="text-center group">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-white">Precision Maintenance</h3>
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg px-2">
