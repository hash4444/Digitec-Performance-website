...
export const aiGuidePostsExtra: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'What the Urus needs in Dubai, from carbon ceramic brake checks to air suspension and gearbox service.',
    category: 'Workshop Guides',
    author: 'DIGI-TEC Workshop',
    date: '2026-08-13',
    readTime: '6 min read',
    ...
    metaDescription:
      'Lamborghini Urus service in Dubai: oil specification, air suspension, brakes, cooling, gearbox service and diagnostics explained for owners.',
    keywords:
      'Lamborghini Urus service Dubai, Urus maintenance Dubai, Lamborghini specialist Dubai, exotic SUV workshop Dubai',
    ogType: 'article',
    content: [
      { type: 'p', text: 'Short answer: the Urus is a fast, heavy SUV, so brakes, air suspension, cooling and gearbox fluid dominate its maintenance needs alongside routine oil service. Digi-Tec Performance Centre in Al Quoz Industrial Area 3, Dubai services the Urus with manufacturer level diagnostics and measures brake and suspension condition rather than estimating it.' },
      { type: 'h2', text: 'What a Urus service covers' },
      {
        type: 'ul',
        items: [
          'Engine oil and filter to the correct approval for the 4.0 V8 twin turbo engine.',
          'Carbon ceramic brake measurement, including disc wear by weight where applicable.',
          ...
          'Automatic gearbox fluid service at interval plus differential oil checks.',
          'Full diagnostic scan with guided testing and coding where required.',
        ],
      },
      { type: 'h2', text: 'Brakes and tyres on a heavy performance SUV' },
      { type: 'p', text: 'Weight plus performance means brake and tyre condition change faster than owners expect. Carbon ceramic discs last well but are not permanent, and their wear must be measured rather than judged by eye. Tyre age matters too, because heat ageing reduces grip long before the tread is used up.' },
      { type: 'h2', text: 'Common Urus issues in Dubai' },
      {
        type: 'ul',
        items: [
          'Air suspension leaks producing an uneven stance when parked.',
          'Brake dust build up and pad deposits from stop start traffic.',
          'Cooling performance loss when radiator faces are blocked by dust.',
          'Gearbox harshness where fluid service has been delayed.',
        ],
      },
      { type: 'h2', text: 'FAQs' },
      { type: 'h3', text: 'How often should a Urus be serviced in Dubai?' },
      { type: 'p', text: 'Annually as a minimum, with a shorter interval for high mileage or hard driven cars.' },
      { type: 'h3', text: 'Do you measure carbon ceramic brake wear?' },
      { type: 'p', text: 'Yes, so replacement decisions are based on measured condition rather than assumption.' },
  ...
  },
  {
    ...
    metaDescription:
      'Rolls-Royce Ghost service in Dubai: air suspension, cooling, electronics, brakes, fluid intervals and diagnostics explained for owners.',
    keywords:
      'Rolls-Royce Ghost service Dubai, Rolls-Royce repair Dubai, Rolls-Royce specialist Dubai, luxury car service Al Quoz',
    ogType: 'article',
    content: [
      { type: 'p', text: 'Short answer: a Ghost is maintained around ride quality and electronics as much as mechanical wear. Air suspension health, cooling condition, battery and charging behaviour, brake condition and a full module scan are the core of a proper service in Dubai. Digi-Tec Performance Centre in Al Quoz Industrial Area 3, Dubai reports measured findings before any repair is approved.' },
      { type: 'h2', text: 'What a Ghost service covers' },
      {
        type: 'ul',
        items: [
          'Engine oil and filter to the correct manufacturer approval.',
          'Air suspension inspection covering ride height, leaks and compressor duty.',
          'Cooling system, coolant condition and auxiliary pump function.',
          'Battery and charging test, including auxiliary systems.',
          'Brake pad, disc and fluid measurement with recorded results.',
          'Full module scan with guided testing where a fault is stored.',
        ],
      },
      { type: 'h2', text: 'Why ride comfort faults deserve early diagnosis' },
      { type: 'p', text: 'A slight change in ride quality is often the first sign of an air suspension or damper fault. Left alone, a small leak makes the compressor run longer, which shortens its life and turns a single component repair into a larger one. Early diagnosis with live data keeps the repair small.' },
      ...
      { type: 'p', text: 'Annually as a minimum, regardless of mileage, with immediate inspection of any ride or electrical symptom.' },
      { type: 'h3', text: 'Do you have diagnostic access for Rolls-Royce?' },
      { type: 'p', text: 'Yes. Manufacturer level diagnostics are used for fault reading, guided testing, coding and programming on the models serviced.' },
