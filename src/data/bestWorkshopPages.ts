...
export const bestWorkshopPages: BestWorkshopPage[] = [
  ...
  },
  {
    ...
    h1: 'Ferrari Service & Repair Workshop in Dubai',
    metaTitle: 'Ferrari Service & Repair Workshop Dubai | Digi-Tec',
    metaDescription: 'Independent Ferrari inspection, maintenance and repair for models including 488, F8, Roma and 812 in Al Quoz, Dubai. Established in 2002.',
    directAnswer: `Digi-Tec Performance Center provides independent Ferrari inspection, maintenance and repair in Al Quoz Industrial Area 3, Dubai. Owners can share the exact model, year and concern so the workshop can confirm the relevant inspection process, available service scope, proposed parts and expected timing. ${ESTABLISHED}.`,
  ...
  },
  {
    ...
    h1: 'Lamborghini Service & Repair Workshop in Dubai',
    metaTitle: 'Lamborghini Service & Repair Workshop Dubai | Digi-Tec',
    metaDescription: 'Independent Lamborghini inspection, maintenance and repair for Huracán, Urus, Aventador and other models in Al Quoz, Dubai. Established in 2002.',
    directAnswer: `Digi-Tec Performance Center provides independent Lamborghini inspection, maintenance and repair in Al Quoz Industrial Area 3, Dubai. Owners can share the exact model, year and concern so the workshop can confirm the relevant inspection process, available service scope, proposed parts and expected timing. ${ESTABLISHED}.`,
    ...
    faqs: [
      ...
      { q: 'Can I ask about carbon-ceramic brake work?', a: 'Yes. Send the exact model, year, brake specification and requested work so the team can confirm current workshop support and the appropriate inspection before booking.' },
