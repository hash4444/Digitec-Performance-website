...
export const BRAND_PROFILES: Record<string, BrandProfile> = {
  ...
  'lamborghini-service-dubai': {
    ...
    climateNote: 'V10 and V12 heat exposure can be considered when reviewing coolant, brake-fluid and gearbox-fluid condition and service history.',
  ...
  'mclaren-service-dubai': {
    ...
    climateNote: 'PCC II hydraulic and accumulator concerns may warrant inspection where symptoms, history or heat exposure indicate it.',
  ...
  'rolls-royce-service-dubai': {
    ...
    climateNote: 'Phantom or Cullinan suspension and N74 V12 concerns may warrant inspection where symptoms, history or condition indicate it.',
...
function composeOilChange(p: BrandProfile): Composed {
  return {
    ...
    faqs: [
      { question: `How often should I change the oil on my ${p.brandName} in Dubai?`, answer: `Follow the service reminder and handbook for the exact model, engine and year. ${p.oilIntervalKm.toLocaleString()} km is a profile reference only, not a universal interval; vehicle use, history and oil condition should be reviewed before recommending a schedule.` },
