...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    whyImportant: 'Steering issues, from heavy or loose feel to vibrations and whyImportant: 'Steering issues, from heavy or loose feel to vibrations and wandering, are not just annoying; they\'re dangerous. A failing steering component can lead to loss of vehicle control. Whether it\'s a hydraulic leak, worn tie rods, or an EPS module fault, steering problems require immediate specialist attention.',; they\'re dangerous. A failing steering component can lead to loss of vehicle control. Whether it\'s a hydraulic leak, worn tie rods, or an EPS module fault, steering problems require immediate specialist attention.',
