...
export const localeMessages = {
  en: {
    nav: { about: 'About Us', services: 'Services', brands: 'Brands', performance: 'GAD Performance', vrx: 'VRX', blog: 'Blog', faq: 'FAQ', contact: 'Contact Us' },
    language: { english: 'English', arabic: 'العربية', menu: 'Language selection' },
  },
  ar: {
    nav: { home: 'الرئيسية', services: 'الخدمات', brands: 'العلامات', about: 'من نحن', performance: 'GAD للأداء', vrx: 'VRX', blog: 'المقالات', faq: 'الأسئلة الشائعة', contact: 'تواصل معنا' },
