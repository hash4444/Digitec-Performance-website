...
const LocalGaragePage = () => {
  ...
  const page = sourcePage && isArabic ? (() => {
    ...
    const faqs = [
      { question: 'أين تقع ديجي-تك؟', answer: 'نقع في القوز الصناعية 3، المستودعات 11–15، دبي.' },
